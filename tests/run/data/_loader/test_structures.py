...
def test__strip_unvoiced_align():
    """Test `_strip_unvoiced_align` strips punctuation from text."""
    text = "...hi..."
    stripped = _strip_unvoiced_align(text, (0, len(text)), language=Language.ENGLISH)
