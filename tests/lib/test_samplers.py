""" Test updated `BucketBatchSampler` with original tests.

Original:
https://github.com/PetrochukM/PyTorch-NLP/blob/master/tests/samplers/test_bucket_batch_sampler.py
"""
...
def test_bucket_batch_sampler_length():
    ...
    batch_sampler = BucketBatchSampler(
        sampler, batch_size=batch_size, sort_key=sort_key, drop_last=False, bucket_size_multiplier=2
    )
