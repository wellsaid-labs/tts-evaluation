...
class Decoder(torch.nn.Module):
    ...
    def __init__(
        ...
        input_size = speaker_embed_size + encoder_output_size
        ...
        self.pre_net = PreNet(num_frame_channels, speaker_embed_size, pre_net_size)
    ...
    def _make_hidden_state(self, encoded) -> DecoderHiddenState:
        ...
        first_token = torch.cat([encoded.speaker, encoded.tokens[0]], dim=1)
    ...
    def forward(
        ...
        **kwargs,
        ...
        pre_net_frames = self.pre_net(frames, encoded.speaker)
        ...
        for frame in pre_net_frames.split(1, dim=0):
            ...
            frame = torch.cat([frame, last_attention_context, encoded.speaker], dim=1)
        ...
        speaker = encoded.speaker.unsqueeze(0)
