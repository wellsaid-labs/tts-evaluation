...
def _set_model_size(frame_channels):
    ...
    encoder_speaker_embedding_dim = 256
    encoder_hidden_size = encoder_speaker_embedding_dim + encoder_lstm_hidden_size
        ...
        'src': {
            'spectrogram_model': {
                'encoder.Encoder.__init__': {
                    ...
                    'lstm_hidden_size': encoder_lstm_hidden_size,  # 512
                    'lstm_layers': 1,
