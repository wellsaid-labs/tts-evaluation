...
def pin_memory_batch(batch):
    if isinstance(batch, torch.Tensor):
        ...
        return batch
    # NOTE: This change was added because ``container_abcs.Sequence`` was changing my ``namedtuple``
    # to a ``list``
        ...
        if self.num_workers > 0:
            ...
            for i in range(self.num_workers):
                ...
                w = multiprocessing.Process(
                    target=_worker_loop,
                    args=(self.dataset, index_queue, self.worker_result_queue, self.done_event,
                          self.collate_fn, base_seed + i, self.worker_init_fn, i))
                w.daemon = True
            ...
            if self.pin_memory:
                ...
                pin_memory_thread = threading.Thread(
                    ...
                    args=(self.worker_result_queue, self.data_queue, torch.cuda.current_device(),
                          self.done_event))
